...
| `VITE_ONEUP_HEALTH_SYSTEM_SEARCH_URL`     | no       | `https://system-search.1up.health/search`     | URL used in EHR's 1UpHealth system search iframe                        |
| `VITE_ONEUP_HEALTH_SYSTEM_SEARCH_API_URL` | no       | `https://system-search.1up.health/api/search` | URL used to check 1UpHealth client-side communication                   |
