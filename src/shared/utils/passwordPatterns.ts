...
// Visible characters plus ZWJ/ZWNJ only when gluing extended pictographics (e.g. 👩‍💻), not arbitrary text.
export const VISIBLE_ONLY_REGEXP =
  /^(?:[\p{L}\p{Nd}\p{P}\p{S}\p{M}]|\p{Extended_Pictographic}(?:[\u200C\u200D]\p{Extended_Pictographic})*)+$/u;
