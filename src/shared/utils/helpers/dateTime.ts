...
export const isSourceTimeBigger = (timeSource: HourMinute, timeTarget: HourMinute) => {
  const minutesElapsedFromStartOfDayForSource = timeSource.hours * MINUTES_IN_HOUR + timeSource.minutes
  const minutesElapsedFromStartOfDayForTarget = timeTarget.hours * MINUTES_IN_HOUR + timeTarget.minutes
  return minutesElapsedFromStartOfDayForSource > minutesElapsedFromStartOfDayForTarget
}
