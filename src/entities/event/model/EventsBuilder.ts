      ...
      return {
        ...
        event: {
          ...
          availability: {
            ...
            startDate: !isAlwaysAvailable ? this.convertToDate(event.availability.startDate, true) : null,
            endDate: !isAlwaysAvailable ? this.convertToDate(event.availability.endDate, true) : null,
